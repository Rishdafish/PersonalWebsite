/*
  ...
  1. Database Functions
    ...
    - Create robust handle_new_user_signup function with proper error handling
    - Create create_user_profile_manual function for fallback profile creation
...
-- Drop existing trigger and functions with CASCADE to handle dependencies
...
DROP FUNCTION IF EXISTS create_user_profile_manual(uuid, text) CASCADE;
