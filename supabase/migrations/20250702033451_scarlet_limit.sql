/*
  ...
  This consolidated migration file contains the complete database schema for the application.
  It includes all tables, functions, triggers, and policies needed for the application to work.
  ...
  ## Functions
  - handle_new_user_signup: Trigger function for new user registration
  - create_user_profile_manual: Function to manually create user profiles
  - update_updated_at_column: Function to update timestamps

  ## Security
  - Row Level Security policies for all tables
  - Role-based access control (admin, specialized, regular)
*/
