/*
  ...
  1. Database Schema
    - User profiles with role-based access (admin, regular, specialized)
    - Blog posts and comments system
    - Projects portfolio management
    - Hours tracking with subjects, work entries, achievements, and statistics
    - Access token system for specialized users

  2. Security
    - Row Level Security enabled on all tables
    - Role-based access policies
    - Admin auto-assignment for specified emails
    - Token-based specialized access
