/*
  ...
  1. User Role Management
    ...
    - Updates user_profiles table to use enum type
    
  2. Authentication Functions
    - handle_new_user_signup: Automatic profile creation on signup
    - create_user_profile_manual: Manual profile creation fallback
...
-- Step 3: Remove ALL existing policies that will be recreated
