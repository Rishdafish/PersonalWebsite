/*
  ...
  1. Functions
    ...
    - Create check_trigger_status function for debugging
    - Create handle_new_user_signup trigger function
    - Create create_user_profile_manual function for manual profile creation
...
-- Drop existing trigger first (this will allow us to drop the function)
DROP TRIGGER IF EXISTS on_auth_user_created ON auth.users;

-- Now drop existing functions safely
