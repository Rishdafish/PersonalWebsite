...
-- Step 9: Create RLS policies for signup process (only if they don't exist)
DO $$
BEGIN
    -- Check and create policies for user_profiles
    IF NOT EXISTS (
    ...
    -- Check and create policies for users
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies 
    ...
    -- Check and create policies for achievements
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies 
    ...
    -- Check and create policies for user_statistics
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies 
